...
('Безплатен', 'free', 'До 10 птици и 1 голубарник', 0, 36500, 10, 1, '["birds","lofts","basic_health"]', 0),
('Стандарт', 'standard', 'До 100 птици, развъждане, тренировки', 29.99, 30, 100, 5, '["birds","lofts","breeding","training","health","competitions"]', 1),
('Професионален', 'pro', 'Неограничени птици, родословно дърво, експорт', 59.99, 30, NULL, NULL, '["all","pedigree_export","public_pedigree","analytics"]', 2);
