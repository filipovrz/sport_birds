...
<option value="race">Състезателен полет</option><option value="show">Изложба</option>
<option value="fight">Бой</option><option value="training_race">Тренировъчен полет</option></select></div>
