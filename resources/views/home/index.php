<div class="hero">
    ...
    <p style="max-width:640px;margin:1rem auto;color:var(--muted)">
        Професионална платформа за собственици и състезатели: спортни гълъби, други гълъби, други спортни птици.
...
<div class="grid grid-3">
    <div class="card">
        ...
        <p>Пръстени, породи, статус, връзки родител–потомък и гълъбарници.</p>
    </div>
    <div class="card">
