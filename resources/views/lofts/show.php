...
<form method="post" action="/dashboard/lofts/<?= (int)$loft['id'] ?>/delete" onsubmit="return confirm('Изтриване на гълъбарника?')">
    <?= csrf_field() ?>
    <button type="submit" class="btn btn-danger btn-sm">Изтрий гълъбарника</button>
</form>
